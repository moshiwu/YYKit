 ...
 */
static inline void dispatch_async_on_main_queue(NS_SWIFT_UI_ACTOR void (^block)()) {
    if (pthread_main_np()) {
        block();
    } else {
 ...
 */
static inline void dispatch_sync_on_main_queue(NS_SWIFT_UI_ACTOR void (^block)()) {
    if (pthread_main_np()) {
        block();
    } else {
